...
EventStateInfo::Iterator event_state_it)
{
    ...
    {
        RB_RESOLVE_GMEM_BUFFER_BASE rb_resolve_gmem_buffer_base_reg;
        rb_resolve_gmem_buffer_base_reg.u32All = m_state_tracker.GetRegValue(
        rb_resolve_gmem_buffer_base_reg_offset);
        event_state_it->SetResolveBaseGmem(rb_resolve_gmem_buffer_base_reg.u32All);
    }
